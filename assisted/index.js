...
function send1() {
  ...
  if(oneone == undefined){
    ...
    location.href='news2_assisted.html'
  }
};
...
function send2() {
  ...
  if(twoone == undefined){
    ...
    location.href='news3_assisted.html'
  }
};
...
function send3() {
  ...
  if(threeone == undefined){
    ...
    location.href='news4_assisted.html'
  }
};
...
function send4() {
  ...
  if(fourone == undefined){
    ...
    location.href='news5_assisted.html'
  }
};
...
function send5() {
  ...
  if(fiveone == undefined){
    ...
    location.href='news6_assisted.html'
  }
};
...
function send6() {
  ...
  if(sixone == undefined){
    ...
    console.log(sixtwo);
    console.log(localStorage.getItem('oneone'));
    location.href='continueUsage_assisted.html'
  }
};
...
function send7() {
  ...
  if(sevenone == undefined){
    ...
    location.href='MBTI_assisted.html'
  }
};
...
function send8() {
  ...
  if(mbti_1 == undefined){
    ...
    location.href='CRT_assisted.html'
  }
};
// $('input[name=name]').val(),
function send9() {
  ...
  if(crt_1 == ""){
    ...
    location.href='personinfo_assisted.html'
  }
};
...
function send10() {
  ...
  // console.log(localStorage.getItem('crt_4'))
  // console.log(oneone)
  if(personinfo_1 == undefined){
    ...
    $.ajax({
      url: "https://script.google.com/macros/s/AKfycbxrLhsxQlM_YcArKRcXAt43y9snjo-j6pMcQu6QgA5CR7MzMq6zvNtB6ATH_eKadbcI/exec",
      data: {
          "oneone": oneone,
          "onetwo": onetwo,
          "onethree": onethree,
